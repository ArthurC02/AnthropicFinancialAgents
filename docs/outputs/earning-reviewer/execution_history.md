...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && python -c "import docx; print('python-docx', docx.__version__)" 2>&1 || pip install python-docx 2>&1 | tail -2
```
...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && pip install python-docx 2>&1 | tail -2
```
...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && python -c "import docx; print('python-docx OK', docx.__version__)" 2>&1
```
...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && python build_tsmc_model.py 2>&1 && python - <<'PY'
...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && python build_tsmc_model.py >/dev/null 2>&1 && python build_tsmc_note.py 2>&1 && ls -la out/ | grep -i tsmc
```

```text
SAVED ./out/TSMC_Q1_2026_Earnings_Note.docx  paragraphs: 32
-rw-r--r-- 1 a8022 197121 39692 Jun 18 11:25 TSMC_Q1_2026_Earnings_Note.docx
-rw-r--r-- 1 a8022 197121 12954 Jun 18 11:25 TSMC_Q1-2026_Model.xlsx
```
...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && python -c "import matplotlib; print('matplotlib', matplotlib.__version__)" 2>&1 || pip install matplotlib 2>&1…
```
...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && pip install matplotlib 2>&1 | tail -2 && python -c "import matplotlib; print('matplotlib OK', matplotlib.__ver…
```
...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && python build_tsmc_charts.py 2>&1
```
...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && python build_tsmc_report.py 2>&1 && ls -la out/TSMC_Q1_2026_Earnings_Update.docx
```

```text
SAVED ./out/TSMC_Q1_2026_Earnings_Update.docx  paragraphs: 66
-rw-r--r-- 1 a8022 197121 436173 Jun 18 11:33 out/TSMC_Q1_2026_Earnings_Update.docx
```
...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && python build_tsmc_dcf.py 2>&1 && python - <<'PY'
...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && ls -la out/*.docx out/*.xlsx 2>&1 | awk '{print $5, $9}'; echo "--- charts ---"; ls out/charts | wc -l
```
...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && python build_tsmc_dcf.py 2>&1 && python build_tsmc_valchart.py 2>&1 && python - <<'PY'
...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && python build_tsmc_report.py 2>&1 && ls -la out/TSMC_Q1_2026_Earnings_Update.docx out/TSMC_DCF_Valuation.xlsx |…
```
