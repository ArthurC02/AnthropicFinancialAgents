...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && ls samples/valuation-reviewer/ 2>&1
```
...
```bash
cd "C:/Users/a8022/Desktop/financial-services" && python build_val_review.py 2>&1 && python - <<'PY'
