...
```text
Write <repo>\samples\valuation-reviewer\gp_valuation_package_2026-Q1.md
32 lines
```
...
```text
Write <repo>\samples\valuation-reviewer\fund_terms_and_positions_2026-Q1.md
54 lines
```
...
```text
total 28
drwxr-xr-x 1 <user> 197121     0 Jun 18 12:55 .
drwxr-xr-x 1 <user> 197121     0 Jun 18 12:55 ..
-rw-r--r-- 1 <user> 197121 13461 Jun 18 12:55 Fund_III_Valuation_Review_2026-Q1.xlsx
-rw-r--r-- 1 <user> 197121  7593 Jun 18 12:52 LP_Report_Draft_2026-Q1.md
```

```text
Read <repo>\out\LP_Report_Draft_2026-Q1.md
```
